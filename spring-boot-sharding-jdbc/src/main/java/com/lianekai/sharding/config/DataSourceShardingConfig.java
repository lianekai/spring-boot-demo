package com.lianekai.sharding.config;
...
public class DataSourceShardingConfig {
    ...
    private Map<String, DataSource> dataSourceMap() {
        ...
        ds0.setJdbcUrl("jdbc:mysql://127.0.0.1:3306/sharding1?useUnicode=true&characterEncoding=UTF-8&useSSL=false&autoReconnect=true&failOverReadOnly=false&serverTimezone=GMT%2B8");
        ...
        ds1.setJdbcUrl("jdbc:mysql://127.0.0.1:3306/sharding2?useUnicode=true&characterEncoding=UTF-8&useSSL=false&autoReconnect=true&failOverReadOnly=false&serverTimezone=GMT%2B8");
